...
- **Optional:** A [Tiller Money](https://www.tillerhq.com) subscription for automatic transaction import
...
- View envelopes by **Account** or by **groups** (Annual, Monthly, Investments, etc.)
...
The first time you open your copy of the sheet, the Startup Wizard walks you through getting set up — start fresh, upgrade from a previous sheet, migrate from Tiller, or load sample data.

[See the Startup Wizard guide](/ue26/startup-wizard/){: .btn .btn--primary }
