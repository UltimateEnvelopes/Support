...
Ultimate Envelopes is a comprehensive envelope budgeting system built on Google Sheets that leverages Tiller for data aggregation. The Service:

- Provides envelope budgeting functionality within Google Sheets
- Integrates with Tiller Money for automated transaction data
- Operates entirely within Google Sheets
- Processes your financial data to help you manage budgets using the envelope method
- Does not store your data on external servers beyond Google's infrastructure

**Note:** Tiller Money is a separate third-party service. You must have an active Tiller subscription to use Ultimate Envelopes' full functionality. Ultimate Envelopes is not affiliated with, endorsed by, or officially connected to Tiller Money.
...
You may use Ultimate Envelopes for:
...
- Access financial transaction data provided by Tiller in your spreadsheet
...
You may NOT use Ultimate Envelopes to:
...
Ultimate Envelopes relies on Tiller Money for transaction data aggregation. You acknowledge that:

- Tiller Money is a separate, independent service
- You must maintain your own Tiller subscription
- Ultimate Envelopes is not responsible for Tiller's service availability, accuracy, or pricing
- Changes to Tiller's service may affect Ultimate Envelopes functionality
- You must comply with Tiller Money's Terms of Service
- Tiller Money's data feed delays or errors are beyond our control

For Tiller-related issues, please contact Tiller support directly at https://www.tillerhq.com/support/

### Google Services

Ultimate Envelopes operates within Google Sheets and relies on Google's infrastructure. Your use is also subject to:

- [Google Terms of Service](https://policies.google.com/terms)
- [Google API Services User Data Policy](https://developers.google.com/terms/api-services-user-data-policy)

We are not responsible for Google's services or any issues arising from Google's platform.
...
Ultimate Envelopes, including all code, design, graphics, and documentation, is owned by the developer and is protected by copyright, trademark, and other intellectual property laws.
...
- Tiller service interruptions may affect functionality
...
- Non-infringement
- Accuracy, reliability, or completeness of budgeting calculations
- That the Service will meet your financial management needs
- That the Service will be error-free or uninterrupted
- That financial data from Tiller will be accurate or timely
- That using the envelope budgeting method will improve your financial situation
...
- Your violation of Tiller Money's terms of service

## 14. Data Backup and Loss

**YOU ARE RESPONSIBLE FOR BACKING UP YOUR SPREADSHEET DATA.**

- We strongly recommend making regular copies of your budget spreadsheet
- Use Google Sheets' version history feature to track changes
- Export your data periodically to other formats
- We are not responsible for data loss due to Google Sheets issues, user error, or any other cause
...
- We do not access your bank account information
- All financial data processing occurs within your Google Sheet
...
Before filing any formal claim, you agree to contact us at support@ultimateenvelopes.com to attempt to resolve the dispute informally.
...
These Terms constitute the entire agreement between you and Ultimate Envelopes regarding the Service.
...
**Email:** support@ultimateenvelopes.com  
